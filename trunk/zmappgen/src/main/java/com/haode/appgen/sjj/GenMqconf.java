...
public class GenMqconf {


	public static void main(String[] args) {

		// 项目名称
		String projectName = "com.haodechina.platform.mqconf";

		// 项目ID
		String projectId = "com.haodechina.platform.mqconf";

		// 生成项目 目的位置(绝对路径)
		String projectPath = "F:\\usr\\eclipse372workspace\\com.haodechina.platform.mqconf\\generationCode";

		// 生成项目 所需模板的 相对位置
		String templetPath = "vm/sjj";

		// 基本包结构
		String basePackage = "com.haodechina.platform.mqconf";
		...
		String excelPath = "F:\\usr\\eclipse372workspace\\com.haodechina.platform.mqconf\\design\\";
